...
test.describe('Settings Page', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    await auth.navigateToAdminPage(page, 'admin.php?page=bigrock_in#/settings');
  });

  test('Is Accessible', async ({ page }) => {
    // Wait for the main app container to be rendered
    await page.waitForSelector('#wppbr-app-rendered', { timeout: 10000 });
  ...
  test('Has Coming Soon Section', async ({ page }) => {
    const comingSoonSection = page.locator('.wppbr-app-settings-coming-soon');
  ...
  test('Autoupdate Toggles function properly', async ({ page }) => {
    const updatesSection = page.locator('.wppbr-app-settings-update');
...
test('Comment Settings Work', async ({ page }) => {
    const commentsSection = page.locator('.wppbr-app-settings-comments');
