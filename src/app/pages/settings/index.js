...
const Settings = () => {
	...
	return (
		<Page title="Settings" className={"wppbr-app-settings-page"}>
			<Container className={'nfd-settings-app-wrapper wppbr-app-settings-container'}>
				<Container.Header className={'wppbr-app-settings-header'}>
					<Title as="h2" className="nfd-flex nfd-items-center nfd-gap-2">
						<AdjustmentsHorizontalIcon className="nfd-w-8 nfd-h-8" />
						{__('Settings', 'wp-plugin-bigrock')}
					</Title>
					<span>{__('Manage common settings for your website.', 'wp-plugin-bigrock')}</span>
				</Container.Header>
				...
				<details className="nfd-details settings-details" open>
					...
					<Container.Block separator={true} className={
						classNames(
							'wppbr-app-settings-coming-soon',
							useContainerBlockIsTarget('coming-soon-section') && 'wppbr-animation-blink'
						)}>
						<ComingSoon />
					</Container.Block>

					<Container.Block separator={true} className={'wppbr-app-settings-update'}>
						<AutomaticUpdates />
					</Container.Block>

					<Container.Block separator={true} className={'wppbr-app-settings-wonder-blocks'}>
						<Container.SettingsField
								title={ __( 'Features', 'wp-plugin-bigrock' ) }
								description={ __(
					...
					<Container.Block separator={true} className={'wppbr-app-settings-content'}>
						<ContentSettings />
					</Container.Block>

					<Container.Block className={'wppbr-app-settings-comments'}>
						<CommentSettings />
					</Container.Block>
				</details>
						...
						<summary>
							<div className="nfd-details-content">
								<Title as={'h1'} className={'nfd-mb-2 nfd-flex nfd-items-center nfd-gap-2'}>
									...
									{__('Performance', 'wp-plugin-bigrock')}
								</Title>
								<Title 
									as={'h2'}
									className="nfd-font-normal nfd-text-[13px]"
								>
									{__('Optimize your website by managing cache and performance settings', 'wp-plugin-bigrock')}
								</Title>
							</div>
							<span className="nfd-details-icon">
								<ChevronUpIcon />
