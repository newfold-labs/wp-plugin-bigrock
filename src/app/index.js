...
const AppBody = ( props ) => {
	...
	return (
		<main
			id="wppbr-app-rendered"
			className={ classNames(
				'wpadmin-brand-web',
				`wppbr-wp-${ NewfoldRuntime.wpVersion }`,
				`wppbr-page-${ kebabCase( location.pathname ) }`,
				props.className,
		...
		>
			...
			/>
			<div className="wppbr-app-body">
				<div className="wppbr-app-body-inner">
			...
			<div className="wppbr-app-snackbar">
...
export const App = () => (
	<AppStoreProvider>
		<Root context={{ isRtl: false }}>
			<NotificationFeed>
				<Router>
					<div className="wppbr-app-container nfd-flex nfd-flex-col">
						<AppNav />
						<AppBody />
					</div>
				</Router>
